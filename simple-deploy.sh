...
ssh ${REMOTE} "systemctl stop tomcat8.service ; rm /var/lib/tomcat8/webapps/simlar-server*.war ; mv "${REMOTE_DIR}"/simlar-server*.war /var/lib/tomcat8/webapps/ ; systemctl start tomcat8.service"
